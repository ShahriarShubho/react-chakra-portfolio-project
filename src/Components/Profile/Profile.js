...
const Profile =() => {
    ...
    return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%"
            maxWidth={{ base: "100vh", md: "130vh", lg: "90%", xl: "100%" }}>
            ...
            <Box alignSelf="center" px="20"  py="16">
                <Text fontWeight="bold" fontSize="2xl">Product Designer and Developer, specialised in MERN Stack development.</Text>
                <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={8} >
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0}
                        bg="gray.100" h="40vh" w="40vh" justify="flex-end" _hover={{ bg: "teal.400", }}>
                    ...
                    <Flex rounded="xl" direction="column" mt={4} ml={isNotSmallerScreen ? 4 : 0}
                        bg="gray.100" h="40vh" w="40vh" justify="flex-end"
                        _hover={{ bg: "green.400", }}
